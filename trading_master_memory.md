...
## ACTIVE TRADES LOG
*No active trades as of May 19, 2026.*
...
- `strategy_id` column added to Supabase trades table
- `exit_time` column added to Supabase trades table (SQL below)
...
| May 19, 2026 | **Bug fix — TradeView blank page** — guarded undefined filteredTrades/trades/strategies/levels props with Array.isArray() checks |
| May 19, 2026 | Added MYM and MCL to Key Levels and Pre-Trade Check widget |
| May 19, 2026 | Reports — fixed Best Week / Worst Week showing blank when value is $0 |
| May 19, 2026 | Reports — fixed Avg Win Week / Avg Loss Week showing blank |
| May 19, 2026 | Added `exit_time` field to trade form (Entry Time / Exit Time side by side) |
| May 19, 2026 | Reports — Trade Duration section added below By Day of Week (avg, avg winner, avg loser, distribution bar chart) |
| May 19, 2026 | **Global UI brightness pass** — all dull grey text (#444/#555/#666) brightened to #999/#aaa/#bbb across all pages |
| May 19, 2026 | Aggregate/stat values bolded and enlarged across Dashboard, Reports, TradeView, Strategies |
| May 19, 2026 | Reports toggle buttons (Daily/Weekly/Monthly) — brightened to white, bolder font |
| May 19, 2026 | Dashboard calendar — day numbers, week labels, trade counts all brightened |

---

## MAY 19, 2026 UI HANDOFF NOTES

Files changed today and committed to GitHub:
- `src/App.js` — added `exit_time` to EMPTY_FORM
- `src/App.css` — global brightness pass on all dull text colors
- `src/pages/TradeView.jsx` — bug fix for blank page + MYM/MCL + exit_time field + brightness pass
- `src/pages/Dashboard.jsx` — calendar brightness pass
- `src/pages/Reports.jsx` — duration section + best/worst week fix + brightness pass
- `src/pages/Strategies.jsx` — brightness pass

Current file locations in repo:
- `src/App.js`, `src/App.css`, `src/AIChat.js`
- `src/components/DateRangePicker.jsx`, `src/components/AIChat.jsx`
- `src/pages/Dashboard.jsx`, `src/pages/Reports.jsx`, `src/pages/TradeView.jsx`, `src/pages/Strategies.jsx`
